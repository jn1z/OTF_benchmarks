...
public class InputTVLanguageProjectionIterated implements IInput {

    private final static Logger LOGGER = LoggerFactory.getLogger(InputTVLanguageProjectionIterated.class);

    private final static int NUM = 100;

    private final static int SIZE_MIN = 4;
    private final static int SIZE_MAX = 4;
    private final static int SIZE_INC = 1;

    // Alphabet size.
    private final static int ALPH_SIZE_MIN = 16;
    private final static int ALPH_SIZE_MAX = 32;
    private final static int ALPH_SIZE_INC = 8;

    // Compression factor of language, e.g., 2x - 5x. Here we use the sqrt of the usual size, since we do it twice
    private final static float CF_MIN = 1.3f;
    private final static float CF_MAX = 1.7f;
    private final static float CF_INC = 0.1f;

    private final static int WARMUP = 20;

    private final static float AF = 0.1f;
